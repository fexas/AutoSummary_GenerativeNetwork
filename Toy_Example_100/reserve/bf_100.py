...
default_lr =  0.0005 # 0.0005
epoch = 700

# MCMC Parameters Setup
N_proposal = 1000 # 3000
n_samples = 150 # 100
burn_in = 400 # 350 # 250 #249
thin = 30 # 10
Ns = 5
proposed_std = 0.035 # 0.05
quantile_level = 0.0015 # 0.0025  # 0.001 # quantile level for bandwidth estimation
epsilon_upper_bound = 0.03 # 0.05 # 0.01
...
mcmc_samples_folder = "bf_mcmc_samples"
...
quan1_record_csv = "bf_quan1_record.csv"
...
def run_experiment(it):
    ...
    def mcmc_refinement(
        ...
        for i_mcmc in range(n_samples + burn_in):
            ...
            mcmc_samples.append(current_theta)
    ...
    total_mcmc_samples_path = os.path.join(mcmc_samples_folder, f"bf_{n}_mcmc_samples_{it}.npy")
